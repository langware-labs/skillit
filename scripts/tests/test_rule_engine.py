...
class TestActivationRule:
    ...
    def test_from_json_loads_fields(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            rule = ActivationRule.init_record(rule_dir / "record.json")
    ...
    def test_is_valid(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            valid_rule = ActivationRule.init_record(valid_dir / "record.json")
            ...
            invalid_rule = ActivationRule.init_record(invalid_dir / "record.json")
