...
2. Copy the skill template folder from /Users/shlom/Documents/dev/skillit/templates/skill_template to the rules folder and rename it to match the issue name.
